...
public abstract class HeaderAndFooterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean isFooterViewPos(int position) {
        return position >= getHeaderViewCount() + getInnerItemCount() && position < getShowedViewCount();
    }
    ...
    void addHeader(Object data,int type,int position){
        mHeaders.add(position,new DataBean(data,type));
    }
